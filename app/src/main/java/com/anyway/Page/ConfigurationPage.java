 ...
 */
public class ConfigurationPage extends android.support.v4.app.Fragment {
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        LinearLayout linearLayout=(LinearLayout)inflater.inflate(R.layout.page_configuration,container,false);
